function [ S_new ] = augment_rs_DCT( S_old,y_S,k,J,lambda,X_new, w, h, w_factor, h_factor)
...
for i=1:k
    norm_new = getImgFromDCTCoefs(X_new(:, i) + lambda*sign(J(:,y_S(i)+1,i)), w, h, w_factor, h_factor);
