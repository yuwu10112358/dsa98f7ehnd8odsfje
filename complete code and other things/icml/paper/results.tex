...
\begin{figure*}
	...
	\qquad
	\subfigure[Papernot Algorithm]{\label{fig:missclassify_papernot}\includegraphics[width =0.415\linewidth, trim = 110 240 130 255, clip]{figs/missclass_papernot.pdf}}
...
\begin{figure*}
	...
	\qquad
	\subfigure[Papernot Algorithm]{\label{fig:missclassify_papernotpca}\includegraphics[width =0.415\linewidth, trim = 110 240 130 255, clip]{figs/missclass_papernot_pca.pdf}}
...
%		\includegraphics[width = 0.95\textwidth, trim = 50 180 70 210, clip]{figs/misclass_goodfellow.pdf}
%		\caption{Misclassification rate vs. iteration of the Jacobian-based dataset augmentation without feature reduction for FGS method}
%	\end{minipage}
%	\qquad
%	\begin{minipage}{0.45\linewidth}
%		\centering
%		\label{fig:missclassify_papernot}
%		\includegraphics[width =\textwidth, trim = 110 240 130 245, clip]{figs/missclass_papernot.pdf}
%		\caption{Misclassification rate vs. iteration of the Jacobian-based dataset augmentation without feature reduction for Papernot method}
%	\end{minipage}
%	\begin{minipage}{0.45\linewidth}
%		\centering
%		\label{fig:missclassify_fgspca}
%		\includegraphics[width = 0.95\textwidth, trim = 50 180 70 210, clip]{figs/misclass_goodfellow_pca.pdf}
%		\caption{Misclassification rate vs. iteration of the Jacobian-based dataset augmentation with PCA for FGS method}
%	\end{minipage}
%	\qquad
%	\begin{minipage}{0.45\linewidth}
%		\centering
%		\label{fig:missclassify_papernotpca}
%		\includegraphics[width =\textwidth, trim = 110 240 130 245, clip]{figs/missclass_papernot_pca.pdf}
%		\caption{Misclassification rate vs. iteration of the Jacobian-based dataset augmentation with PCA for Papernot method}
%	\end{minipage}
%\end{figure*}
...
\begin{figure}
    \centering
    \includegraphics[width =0.97\linewidth, trim = 120 295 150 280, clip]{figs/confusion_matrix_oracle.pdf}
